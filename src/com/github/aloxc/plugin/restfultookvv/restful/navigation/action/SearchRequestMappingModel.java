...
import com.github.aloxc.plugin.restfultookvv.restful.common.spring.AntPathMatcher;
import com.github.aloxc.plugin.restfultookvv.restful.method.HttpMethod;
 ...
 */
public class SearchRequestMappingModel extends FilteringGotoByModel<HttpMethod> implements DumbAware, CustomMatcherModel {

    protected SearchRequestMappingModel(@NotNull Project project, @NotNull ChooseByNameContributor[] contributors) {
